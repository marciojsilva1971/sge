# 📱 Manual Prático do Colaborador: Cadastro de Despesas de Combustível (SGE)

Este guia ilustrado foi desenvolvido para orientar os colaboradores de campo e equipe de militância na prestação de contas diária de **combustível e abastecimentos de veículos** durante as atividades da campanha eleitoral.
...
## 💡 Dicas Importantes para Evitar Reprovação

> [!TIP]
> * **Evite Sombras e Reflexos:** Fotografe o comprovante em local bem iluminado para garantir a nitidez na prestação de contas eleitoral.
> * **Cupom Danificado?** Caso a impressora do posto falhe ou apague o comprovante, solicite imediatamente uma **Nota Fiscal Eletrônica (NFC-e ou NF-e)** com a chave de acesso impressa.
> * **Notificações:** Se o financeiro rejeitar seu comprovante por falta de informação, você receberá um alerta no Portal permitindo o reenvio da foto correta sem perder o lançamento.
