...
$router->post('/portal/viagem/editar', 'PortalController@updateTravel');
$router->get('/portal/militancia', 'PortalController@militancy');
$router->post('/portal/militancia', 'PortalController@addMilitancy');
$router->post('/portal/militancia/editar', 'PortalController@updateMilitancy');
...
$router->get('/portal/perfil', 'PortalController@profile');
$router->post('/portal/perfil', 'PortalController@updateProfile');
